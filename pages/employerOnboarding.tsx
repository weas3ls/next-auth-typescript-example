            ...
            {!formSubmitted ? (
                ...
                <>
                    <Center>
                        <Box>
                            <Text mb={5}>
                                Thank you for providing us with your information! A verification email will be sent to
                                the email you provided
                                <br /> If you do not see an email from us within the next 24 hours, please check your
                                spam folder
                            </Text>
                            <Text mb={5}>
